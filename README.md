...
#### How to Run
````
Execute the following command: npm {suiteName} - npm linkinBioFunctionality
These suites contain both TC01 and TC02 under it as a result it will test both of them in succession
````
##### Suites
````
TestCase01 : This Test case covers the Functionality of Cart Button which covers:
...
TestCase02: This Test Case covers the Functionality of Link Button which covers:
