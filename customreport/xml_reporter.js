...
(function(global) {
    ...
    exportObject.CustomXmlReporter = function(options) {
        var self = this;
        self.started = false;
        self.finished = false;
        // sanitize arguments
        ...
        function getQualifiedId(suite, isFilename) {
            var fullName;
            var indexValue;
            ...
            if (self.useDotNotation || isFilename) {
                ...
                {
                    indexValue = fullName.indexOf(":");
                    fullName = fullName.substr(0,indexValue);
                }
                else
                {
                    fullName = "";
                ...
                for (var parent = suite._parent; parent; parent = parent._parent) {
                    var getNestedId = parent.description;
                    if(getNestedId.includes(":"))
                    {
                        indexValue = getNestedId.indexOf(":");                    
                        fullName = getNestedId.substr(0,indexValue) + "." + fullName;
                    }
                   else 
                   {
                        //fullName = getNestedId + "." + fullName;
                        fullName = "";
                   }
